...
public class BangalorePeople extends Bangalore implements Company {
    ...
    public BangalorePeople(String countryName, int cityId, String cityName, int companyId, String companyName, String memberName, int memberAge, String memberEducation, String memberFatherName, String memberMotherName, int memberIncome, int pinCode) {
